...
//hacemos un singleton para que solo haya una suscripcion al timerservice
class TimerService{
  ...
  dispose() {
    ...
    this.#processID && clearInterval(this.#processID); //Si se detecta un "apagado", 
    //cancela la acción reiterativa iniciada por setInterval(). Funciona como un if.
    this.#processID = null; //Reinicia la variable a "apagado", 
    //a la espera de una nueva suscripción.
  }
}
